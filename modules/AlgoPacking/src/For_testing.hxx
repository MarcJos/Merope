...
inline void nonRegression_Tore() {
    ...
    if (A_2D_1->getSpheres().size() != 26676) {
        throw runtime_error("Unexpected number of spheres!");
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////
    delete A_2D_1;
    AlgoRSA2D* A_2D_2 = new AlgoRSA2D(TORE_LENGTH_2D, DESIRED_RPHI,
        EXCLUSION_DISTANCE, SEED, 2);
    if (A_2D_2->getSpheres().size() != 26676) {
        throw runtime_error("Unexpected number of spheres!");
    }
    delete A_2D_2;
    /////////////////////////////////////////////////////////////////////////////////////////////////
    AlgoRSA3D* A_3D_1 = new AlgoRSA3D(TORE_LENGTH_3D, DESIRED_RPHI,
        EXCLUSION_DISTANCE, SEED, 1);
    if (A_3D_1->getSpheres().size() != 1760) {
        throw runtime_error("Unexpected number of spheres!");
    }
    delete A_3D_1;
    /////////////////////////////////////////////////////////////////////////////////////////////////
    AlgoRSA3D* A_3D_2 = new AlgoRSA3D(TORE_LENGTH_3D, DESIRED_RPHI,
        EXCLUSION_DISTANCE, SEED, 2);
    if (A_3D_2->getSpheres().size() != 1760) {
        throw runtime_error("Unexpected number of spheres!");
    }
    delete A_3D_2;
    /////////////////////////////////////////////////////////////////////////////////////////////////
...
inline void variousTests() {
    ...
    // DATA
    Point<2> ToreLength_2D({ 20., 20. });
    Point<3> ToreLength_3D({ 20., 20., 20. });
...
inline void TestWP(string nameShape) {
    ...
    algo.setBigShape(vector<double> { 40., 40., 40. }, nameShape);
