...
#  MKL_ROOT_LIB     -  MKL library dir (for dlls!)
#
#
#
# Sample usage:
...
if (NOT MKL_ROOT_DIR)
    ...
    if (MKL_INCLUDE_DIRS MATCHES "Composer.*2013")
        list(APPEND MKL_LINK_TOOL_COMMAND "--mkl=ComposerXE2013")
    elseif (MKL_INCLUDE_DIRS MATCHES "Composer.*2011")
        list(APPEND MKL_LINK_TOOL_COMMAND "--mkl=ComposerXE2011")
    elseif (MKL_INCLUDE_DIRS MATCHES "10.3")
    ...
    elseif(MKL_INCLUDE_DIRS MATCHES "2016")
        list(APPEND MKL_LINK_TOOL_COMMAND "--mkl=11.3")
    elseif(MKL_INCLUDE_DIRS MATCHES "2017")
        list(APPEND MKL_LINK_TOOL_COMMAND "--mkl=11.3")
    elseif(MKL_INCLUDE_DIRS MATCHES "2018")
        list(APPEND MKL_LINK_TOOL_COMMAND "--mkl=11.3")
    elseif (MKL_INCLUDE_DIRS MATCHES "10")
    ...
    if (WIN32)
        set(MKL_ROOT_LIB "${MKL_ROOT_DIR}/lib/${MKL_LIB_DIR}/" "${MKL_ROOT_DIR}/../compiler/lib/${MKL_LIB_DIR}")
        ...
        foreach(i ${MKL_LIBS})
            find_library(FULLPATH_LIB ${i} PATHS "${MKL_ROOT_LIB}")
        ...
        if (MKL_LINK_TOOL_COMMAND MATCHES "static")
            ...
            # set(MKL_ROOT_LIB ${INTEL_LIB_DIR} "${MKL_ROOT_DIR}/../compiler/lib/${MKL_LIB_DIR}")
            set(MKL_ROOT_LIB ${INTEL_LIB_DIR})            
    ...
    if (FINDMKL_DEBUG_MODE)
        ...
        message(STATUS "Found MKL_ROOT_LIB:\n${MKL_ROOT_LIB} ")
        message(STATUS "Found MKL_INCLUDE_DIRS:\n${MKL_INCLUDE_DIRS} ")
    endif()

    include(FindPackageHandleStandardArgs)
    find_package_handle_standard_args(MKL DEFAULT_MSG MKL_INCLUDE_DIRS MKL_LIBRARIES)

    mark_as_advanced(MKL_INCLUDE_DIRS MKL_LIBRARIES MKL_DEFINITIONS MKL_ROOT_DIR)
endif()

if(NOT MKL_ROOT_LIB OR NOT MKL_INCLUDE_DIRS)
