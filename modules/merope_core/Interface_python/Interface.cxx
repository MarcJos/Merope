...
void createModule_merope(py::module_& merope) {
    ...
    py::class_<vox::Voxellation<3>>(merope, "Voxellation_3D")
        ...
        .def("printFieldFile", &vox::Voxellation<3>::printFieldFile)
        ;
    ...
    py::class_<vox::Voxellation<2>>(merope, "Voxellation_2D")
        ...
        .def("printFieldFile", &vox::Voxellation<2>::printFieldFile)
        ;
    ...
    py::class_<CartesianField<3>>(merope, "CartesianField_3D")
        ...
        .def(py::init<const gaussianField::NumericalCovariance<3>&, const Point<3>&>())
    ...
    py::class_<CartesianField<2>>(merope, "CartesianField_2D")
        ...
        .def(py::init<const gaussianField::NumericalCovariance<2>&, const Point<2>&>())
    ...
    py::class_<gaussianField::NumericalCovariance<3>>(gaussianField, "NumericalCovariance_3D")
        .def(py::init<std::function<double(Point<3>)>>())
        ;

    py::class_<gaussianField::NumericalCovariance<2>>(gaussianField, "NumericalCovariance_2D")
        .def(py::init<std::function<double(Point<2>)>>())
        ;
