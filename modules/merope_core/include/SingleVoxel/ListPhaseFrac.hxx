...
public:
    ...
    //! set a pure phase
    void set_pure(PHASE_FRAC::PHASE_TYPE phase) { this->resize(1); (*this)[0] = PHASE_FRAC(phase, 1.); }
    ...
    void renormalize(bool is_there_matrix = true, typename ListPhaseFrac<PHASE_FRAC>::PHASE_FRAC::PHASE_TYPE matrixPhase = 0);
    //! merge + renormalize
    void postProcess(const MatrixPhaseHolder<typename PHASE_FRAC::PHASE_TYPE>& matrixPhaseHolder);
private:
