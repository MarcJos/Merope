...
They are usually generated by `Sac_de_billes` but may as well be created and modified as objects in the python script (see [hexagones.py](/tests/microstructures/hexagones/hexagones.py)).
